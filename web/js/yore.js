...
$(function() {
    ...
    console.log("%cby 𝕭𝖑𝖆𝖈k̴͗͘𝖗𝖚𝖘𝖍 † Blackrush LLC\nTarpon Springs, Florida\nInquiries:blackrushdrive@gmail.com\n","font-weight: bold; font-size: 10px;color: #ff6600;");
    console.log("Check out the GitHub repository: https://github.com/blackrushllc/yore");
